# LCSC Auto Import- Frontend Code

This directory contains the frontend code for the LCSC Auto Import plugin.
...
This will compile the frontend into the `../lcsc_auto_import/static` directory (ready for distribution).
